<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('bank_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.banks.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/banks") || request()->is("admin/banks/*") ? "active" : "" }}">
        ...
        @can('feedback_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.feedback.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/feedback") || request()->is("admin/feedback/*") ? "active" : "" }}">
